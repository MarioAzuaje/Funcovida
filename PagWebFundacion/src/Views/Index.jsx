        ...
        <section>
            ...
            <div className='containerV'>
                ...
                <p className='Articulo'>
                    ...
                    Ley2 ? ( <b>Mensaje cuando setLey2 es true</b>) :
                    Ley3 ? (<b>Mensaje cuando setLey3 es true</b> ) :
                    (
                        <p></p>
                    )}
                    ...
                    Ley2 ? ( <p>Mensaje cuando setLey2 es true</p>) :
                    Ley3 ? (<p>Mensaje cuando setLey3 es true</p> ) :
                    (
                        <p></p>
                    )}
                </p>
            ...
            <div className='containerLeyes'>
                ...
                {Ley1 ? (<img src="Ley1.jpeg" alt="imgLey1" />) :
                    Ley2 ? (<img src="Ley1.jpeg" alt="imgLey2" />) :
                    Ley3 ? (<img src="Ley1.jpeg" alt="imgLey3" />) :
                    (
                        <p></p>
                    )}
                </div>
                ...
                <div className='container3Leyes'>
                    ...
                    <div onClick={() => {setLey1(false); setLey2(true); setLey3(false)}}>
                        <img src="Ley1.jpeg" alt="imgLey2" />
                    </div>
                    <div onClick={() => {setLey1(false); setLey2(false); setLey3(true)}}>
                        <img src="Ley1.jpeg" alt="imgLey3" />
                    </div>
                </div>
            </div>
        </section>
